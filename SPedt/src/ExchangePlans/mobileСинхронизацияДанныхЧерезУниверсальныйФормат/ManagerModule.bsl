...
Процедура ПриПолученииНастроек(Настройки) Экспорт
	...
	Настройки.ИмяКонфигурацииПриемника = новый Структура("mobileSP");
	Настройки.НазначениеПланаОбмена = "СинхронизацияСДругойПрограммой"; 	

	Настройки.ЭтоПланОбменаXDTO = Истина;
	Настройки.ФорматОбмена = "http://www.100sp.ru/mobileApi1";
	ВерсииФормата = Новый Соответствие;
	ВерсииФормата.Вставить("2.0.0.0", mobileМенеджерОбменаЧерезУниверсальныйФормат);
...
Процедура ПриПолученииВариантовНастроекОбмена(ВариантыНастроекОбмена, ПараметрыКонтекста) Экспорт
	...
	ВариантНастройки = ВариантыНастроекОбмена.Добавить();
	ВариантНастройки.ИдентификаторНастройки        = "МК";
...
Процедура ПриПолученииОписанияВариантаНастройки(ОписаниеВарианта, ИдентификаторНастройки, ПараметрыКонтекста) Экспорт
	...
	ЗаголовокКоманды   = НСтр("ru = 'Синхронизация данных с мобильным приложением (УФ)'");
	ЗаголовокПомощника = "";
	ЗаголовокУзла      = "";
	
	Если ИдентификаторНастройки = "МК" Тогда
		ИмяКонфигурацииКорреспондента          = "mobileSP";
		НаименованиеКонфигурацииКорреспондента = НСтр("ru = 'Мобильное приложение'");
		
		КраткаяИнформацияПоОбмену = НСтр("ru = 'Позволяет синхронизировать данные с мобильным приложениемчерез универсальный формат mobileSP.
		|В синхронизации данных участвуют следующие типы данных:
		| - справочники (МестаХранения, Габариты, ПунктыВыдачи),
		| - документы (Расходная, Приходная).'");
		
		ЗаголовокКоманды   = НСтр("ru = 'Полная синхронизация данных с ""Мобильным приложением"" через mobileSP'");
	...
	Иначе
		...
		КраткаяИнформацияПоОбмену = НСтр("ru = 'Позволяет синхронизировать данные с любой программой, поддерживающей универсальный формат обмена ""mobileSP"".
		|В синхронизации данных участвуют следующие типы данных:
		| - справочники (МестаХранения, Габариты, ПунктыВыдачи),
		| - документы (Расходная, Приходная).'");
	КонецЕсли;
...
//	ПодробнаяИнформацияПоОбмену = "ПланОбмена.mobileСинхронизацияДанныхЧерезУниверсальныйФормат.Форма.ПодробнаяИнформация";
	...
	ОписаниеВарианта.ИмяФайлаНастроекДляПриемника           = НСтр("ru = 'Синхронизация данных через уф mobileSP'");
