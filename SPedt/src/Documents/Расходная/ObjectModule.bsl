...
//	СтоСПОбмен_Общий.ОтразитьСтоСПОбмен(ДополнительныеСвойства, Движения, Отказ);
	...
	СписокНоменклатуры.ЗагрузитьЗначения(ДополнительныеСвойства.ТаблицыДляДвижений.ТаблицаОстаткиТоваров.ВыгрузитьКолонку("Покупка"));
	СП_ДвиженияСервер.ПроверитьОтрицательныеОстаткиНаСкладе(Ссылка,СписокНоменклатуры, Отказ);
