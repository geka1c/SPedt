...
&НаКлиенте
Процедура ПолучитьНомерОтправленияЗавершение(ПараметрыФИО) Экспорт
...
Процедура УстановитьВидимость()
	...
	ОдноОтправление = (ОБъект.ТарифТК<>0 или ЗначениеЗаполнено(Объект.НомерЗаказа));
	...
	ИндексОтправителя	="";
	Если Объект.Тип="postMail" или Объект.Тип="ems" или Объект.Тип="emsPt" Тогда
