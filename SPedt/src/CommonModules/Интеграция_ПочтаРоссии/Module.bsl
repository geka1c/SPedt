...
Функция СозданиеЗаказаНаДоставку(Параметры,ЭтоEMS=ложь) Экспорт
	...
	Если 	Параметры["ДокументОтправления"].Коробка.МетодОплаты	 = Перечисления.МетодыОплаты.cod Тогда	
...
Функция РассчитатьСтоимость(Параметры) Экспорт
	...
	Протокол.Вставить("Тариф", 			Строка(Параметры.КатегорияРПО) + " "  + Параметры.ВидРПО);
