...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия 			= "3.6.4.32";
	Обработчик.РежимВыполнения 	= "Отложенно";
	Обработчик.Процедура 		= "ОбновлениеИнформационнойБазыСовместныеПокупки.ОбновлениеНаВерсию_3_6_4_32";
	Обработчик.Комментарий 		= НСтр("ru = 'Установить периодичность выгрузки данных'");
...
Процедура ОбновлениеНаВерсию_3_6_4_32(Параметры) Экспорт
	задание = РегламентныеЗадания.НайтиПредопределенное("ВыгрузкаНаСайт");
	задание.Расписание.ПериодПовтораВТечениеДня = 10*60;
