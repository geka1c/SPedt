...
Процедура ПриОпределенииОбъектовСКомандамиПечати(СписокОбъектов) Экспорт
	СписокОбъектов.Добавить(Документы.Расходная); 
	СписокОбъектов.Добавить(Документы.Движение); 
	СписокОбъектов.Добавить(Документы.ДвижениеТранзита); 
	СписокОбъектов.Добавить(Документы.ФормированиеКоробки);
	СписокОбъектов.Добавить(Документы.ВыдачаТранзита);
	СписокОбъектов.Добавить(Документы.УпаковатьЗаказы);
	СписокОбъектов.Добавить(Документы.ВозвратПокупокОрганизатору);
	СписокОбъектов.Добавить(Документы.ПеремещениеВозврата);
	СписокОбъектов.Добавить(Документы.Приходная);
	СписокОбъектов.Добавить(Документы.ПоступлениеПристроя);
	СписокОбъектов.Добавить(Документы.РазборКоробки);
	СписокОбъектов.Добавить(Справочники.Контрагенты);
	СписокОбъектов.Добавить(Справочники.Организации);
	СписокОбъектов.Добавить(ЖурналыДокументов.ВсеПриходы);
	СписокОбъектов.Добавить(Документы.РегистрацияСупперГруппы);
	СписокОбъектов.Добавить(Документы.ОтправлениеТранзита);
	СписокОбъектов.Добавить(Документы.ПередачаВозвратовОрганизатору);
	СписокОбъектов.Добавить(Документы.КурьерскаяДоставка);
	СписокОбъектов.Добавить(Документы.ПечатьСтикеров);
	СписокОбъектов.Добавить(Документы.ЗаказыДляТранзита);
