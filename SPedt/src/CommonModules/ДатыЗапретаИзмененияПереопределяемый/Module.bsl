...
Процедура ЗаполнитьИсточникиДанныхДляПроверкиЗапретаИзменения(ИсточникиДанных) Экспорт
	...
	СписокДокументов.Добавить("Расходная"); 
	СписокДокументов.Добавить("ВыдачаТранзита"); 
	СписокДокументов.Добавить("ФормированиеКоробки"); 
	СписокДокументов.Добавить("Приходная"); 
	СписокДокументов.Добавить("ОтправлениеТранзита"); 
	СписокДокументов.Добавить("Движение"); 
	СписокДокументов.Добавить("ВозвратПокупокОрганизатору"); 
	СписокДокументов.Добавить("Продажа"); 
	СписокДокументов.Добавить("РазборКоробки");		
	
	Для каждого стр из СписокДокументов Цикл
		ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных,
		Метаданные.Документы[стр.Значение].ПолноеИмя(),
		"Дата","","");	
	КонецЦикла;
