...
Процедура ОпределитьРазделыСВариантамиОтчетов(Разделы) Экспорт
	...
	Разделы.Добавить(Метаданные.Подсистемы.ТранспортныеКомпании ,  		  НСтр("ru = 'Отчеты по ТК'"));	
...
Процедура НастроитьВариантыОтчетов(Настройки) Экспорт                                                   
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ВедомостьВозвратов);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ВыданныеЗаказы);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ПоискУчатникаСКД);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ИзмененияДокументов);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.КонсольСистемыКомпоновкиДанных);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ОтчетЗаДеньNew);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ОтчетПоТарифам);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ПоискЗаказов);
	...
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ПокупкиВПутиNEW);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ВедомостьЗаказовТК);

	
//////////////////	
	НастройкиОтчета 			= Метаданные.Отчеты.ВозмещениеЗаРазборНаЕРЦ;
	НастройкиВарианта 			= ВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "ВозмещениеЗаРазборНаЕРЦ");
	НастройкиВарианта.Описание	= НСтр("ru = 'суммы возмещаемые за разбор на ЕРЦ детальный.'");

	НастройкиВарианта 			= ВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "ВозмещениеЗаРазборНаЕРЦСвод");
	НастройкиВарианта.Описание	= НСтр("ru = 'суммы возмещаемые за разбор на ЕРЦ сводный.'");
	
	НастройкиВарианта 			= ВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "ВозмещениеЗаРазборНаЕРЦСвод2");
	НастройкиВарианта.Описание	= НСтр("ru = 'суммы возмещаемые за разбор на ЕРЦ итоговый.'");

//////////////////	
	НастройкиОтчета 			= Метаданные.Отчеты.ОтчетПоКурьерскойДоставке;
	НастройкиВарианта 			= ВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "ОтчетПоКурьерскойДоставке");
	НастройкиВарианта.Описание	= НСтр("ru = 'Заказы доставленые участнику средсвтвами пункта выдачи'");
	
	НастройкиВарианта 			= ВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "ОтчетПоКурьерскойДоставкеДетальный");
	НастройкиВарианта.Описание	= НСтр("ru = 'Заказы доставленые участнику средсвтвами пункта выдачи Детальный'");

//////////////////	
	НастройкиОтчета 			= Метаданные.Отчеты.ОтчетПоБесплатнойВыдаче;
	НастройкиВарианта 			= ВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "ОтчетПоБесплатнойВыдаче");
	НастройкиВарианта.Описание	= НСтр("ru = 'Заказы хранение котроых оплачивает организатор'");
	
	НастройкиВарианта 			= ВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "ОтчетПоБесплатнойВыдачеДетальный");
	НастройкиВарианта.Описание	= НСтр("ru = 'Заказы хранение котроых оплачивает организатор Детальный'");
...
//////////////////	
	НастройкиОтчета 			= Метаданные.Отчеты.ОшибкиОбмена100СП;
	НастройкиВарианта 			= ВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "Основной");
	НастройкиВарианта.Описание	= НСтр("ru = 'Ошибки при обмене с сайтом'");
	
	НастройкиВарианта 			= ВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "Детальный");
	НастройкиВарианта.Описание	= НСтр("ru = 'Ошибки при обмене с сайтом (Детальный)'");

	НастройкиВарианта 			= ВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "Свод");
	НастройкиВарианта.Описание	= НСтр("ru = 'Ошибки при обмене с сайтом (Свод)'");
