...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	Запрос.Текст =
		...
		|	ОтправлениеТранзитаТрекНомера.ВнутреннийНомер,
		|	ОтправлениеТранзитаТрекНомера.Тариф,
		|	ОтправлениеТранзитаТрекНомера.СрокДоставки,
		|	ОтправлениеТранзитаТрекНомера.Длина,
		|	ОтправлениеТранзитаТрекНомера.Ширина,
		|	ОтправлениеТранзитаТрекНомера.Высота
		|ИЗ
		...
		|	0,
		|	ОтправлениеТранзита.ИдентификаторЗаказаВТК,
		|	ОтправлениеТранзита.Тариф,
		|	ОтправлениеТранзита.СрокДоставки,
	...
	Пока Выборка.Следующий() Цикл
		...
		Если не ЗначениеЗаполнено(Движение.Тариф)  Тогда
			Движение.Тариф = "Тариф ТК";
		КонецЕсли;
	КонецЦикла;
