...
Функция ДобавитьГруппуНаТранзит(параметрыГруппы)
	...
	//4400106429000961531346000073
	Если НеРазбиратьКоробки и параметрыГруппы.ПунктВыдачи = Справочники.ТочкиРаздачи.ПунтВыдачиНеУказан Тогда
		новая_строка.ПунктВыдачи = Справочники.ТочкиРаздачи.НайтиПоКоду("0039");		
	Иначе	
...
Процедура ОбработатьШККоробкиНаКлиенте(ДанныеШК)
	...
	Если ДанныеШК.КРазбору и не НеРазбиратьКоробки Тогда
